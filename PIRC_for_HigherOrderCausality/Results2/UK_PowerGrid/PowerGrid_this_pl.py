...
def objective_fast(trial, X=None, Y=None, args=None, T_Matrix=None, ooi=[], dmax=2, ExpandNodes=None):
    ...
    keep_ratio = trial.suggest_categorical("keep_ratio", [1])
    with open("../Kuramoto/results/THIS_result_test.pkl", "rb") as f:
    ...
    Ainf, coeff, relerr = this(
        ...
        lam=params["threshold"], rho=params["alpha"], niter=niter
    )
...
if __name__ == '__main__':
    ...
    with open("results/THIS_result.pkl", "wb") as f:
        pickle.dump(save_dict, f)

    print("Results saved to results/THIS_result.pkl")
