...
def objective_fast(
    ...
    data_lengths = [5,10,15,20,25,30,35,40,50,100,150,200,250,300,500,X_full.shape[0]]
...
if __name__ == '__main__':
        ...
        "trials": [
            {
                ...
                "params": t.params,
                "state": str(t.state),
                "best_T_use": t.user_attrs.get("best_T_use", None),
                "auc_history": t.user_attrs.get("auc_history", None),
            }
    ...
    with open("results/ARNI1_light_result.pkl", "wb") as f:
        pickle.dump(save_dict, f)

    print("Results saved to results/ARNI1_light_result.pkl")
